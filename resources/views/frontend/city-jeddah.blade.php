    ...
    <div class="container mx-auto px-4 relative z-10">
        <div data-aos="fade-up" class="text-center max-w-3xl mx-auto">
            <div class="w-20 h-20 mx-auto mb-6 rounded-full bg-[var(--gold)]/10 flex items-center justify-center">
                <i class="fas fa-city text-3xl text-[var(--gold)]"></i>
            </div>
            <h1 class="text-4xl md:text-6xl font-black text-[var(--text-heading)] mt-3 mb-4">ديكورات جدة</h1>
    ...
    <div class="container mx-auto px-4 max-w-5xl">
        <div class="grid md:grid-cols-2 gap-12 items-center mb-16">
            <div data-aos="fade-left">
                ...
                <h2 class="text-3xl font-black text-[var(--text-heading)] mt-3 mb-4">شركة المصمم الذكي للديكور في جدة</h2>
            ...
            <div data-aos="fade-right" class="rounded-2xl overflow-hidden h-96 bg-gradient-to-br from-[var(--navy)] to-[var(--navy)] flex items-center justify-center">
                <div class="text-center p-8">
                    <i class="fas fa-city text-6xl text-[var(--gold)]/30 mb-4"></i>
                    <p class="text-white/40 text-lg">جدة - المملكة العربية السعودية</p>
                </div>
            </div>
        </div>
    ...
    <div class="container mx-auto px-4 max-w-5xl">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="card-elegant p-6 text-center">
                ...
                <h3 class="font-bold text-[var(--text-heading)] mb-2">ديكورات مكاتب</h3>
