                ...
                <a href="{{ route('project.show', $rp->slug) }}" class="card-elegant group overflow-hidden">
                    @if($rp->image)
                        <div class="aspect-[16/10] overflow-hidden">
                            {!! \App\Services\ImageService::picture($rp->image, $rp->title, 'w-full h-full object-cover group-hover:scale-105 transition-transform duration-700') !!}
                        </div>
                    @endif
                    <div class="p-4">
                ...
                <a href="{{ route('material.show', $rm->slug) }}" class="card-elegant group overflow-hidden">
                    @if($rm->image)
                        <div class="aspect-[4/3] overflow-hidden">
                            {!! \App\Services\ImageService::picture($rm->image, $rm->name, 'w-full h-full object-cover group-hover:scale-105 transition-transform duration-700') !!}
                        </div>
                    @endif
                    <div class="p-4">
